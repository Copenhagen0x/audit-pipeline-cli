...
def draft_cmd(
    ...
    # Sign the bundle digest. Patch #3 round-3 (devils-advocate #2):
    # filename fixed from `jelleo.ed25519.priv` to `jelleo.ed25519` to
    # match what `audit-pipeline sign keygen` produces (sign.py:158).
