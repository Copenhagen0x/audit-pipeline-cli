...
Claim:        The post-init state of a market (vault, c_tot, insurance_fund.balance, pnl_pos_tot, pnl_matured_pos_tot, all OI counters) satisfies every invariant that assert_public_postconditions enforces on subsequent calls.
