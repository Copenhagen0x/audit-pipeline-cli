...
- /tmp/jelleo-snap-aeyakovenko-percolator-3lns1u5f/aeyakovenko-percolator-5059332/src/ (all .rs files, focus on the main module)
- /tmp/jelleo-snap-aeyakovenko-percolator-3lns1u5f/aeyakovenko-percolator-5059332/spec.md (if a spec doc exists)
...
Claim:        Every rounding decision (floor/ceil/round-half-even) is set in the direction that does NOT favor the user against the protocol — fees always round up, payouts always round down, etc.
