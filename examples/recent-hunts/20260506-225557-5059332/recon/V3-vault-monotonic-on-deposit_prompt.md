...
Claim:        User-initiated deposits monotonically increase vault balance by exactly the deposited amount, with no off-by-one credit to claimable PnL or insurance.
