...
Read-only. Do NOT modify any files in /tmp/jelleo-snap-aeyakovenko-percolator-li_9z8kf/aeyakovenko-percolator-5059332 or /tmp/jelleo-snap-aeyakovenko-percolator-li_9z8kf/aeyakovenko-percolator-5059332.
```
...
File: /tmp/jelleo-snap-aeyakovenko-percolator-li_9z8kf/aeyakovenko-percolator-5059332/src/percolator.rs

## Files to read

- /tmp/jelleo-snap-aeyakovenko-percolator-li_9z8kf/aeyakovenko-percolator-5059332/src/ (to find BPF instruction handlers)
- /tmp/jelleo-snap-aeyakovenko-percolator-li_9z8kf/aeyakovenko-percolator-5059332/src/ (to follow internal callers)
...
ID:           SH10-cpi-matcher-state-writes-isolated
Claim:        `TradeCpi`'s matcher CPI cannot write to engine state (specifically `mark_ewma_e6`, `last_effective_price_e6`, or any account's `pos_q`/`capital`/`pnl` fields) except via the wrapper's well-defined return-receipt path — i.e., the CPI matcher is data-only, not state- mutating against the engine.
