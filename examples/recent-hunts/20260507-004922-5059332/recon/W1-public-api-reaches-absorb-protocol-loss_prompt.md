...
- /tmp/jelleo-snap-aeyakovenko-percolator-k34h8q2a/aeyakovenko-percolator-5059332
- /tmp/jelleo-snap-aeyakovenko-percolator-k34h8q2a/aeyakovenko-percolator-5059332
...
Read-only. Do NOT modify any files in /tmp/jelleo-snap-aeyakovenko-percolator-k34h8q2a/aeyakovenko-percolator-5059332 or /tmp/jelleo-snap-aeyakovenko-percolator-k34h8q2a/aeyakovenko-percolator-5059332.
```
...
- /tmp/jelleo-snap-aeyakovenko-percolator-k34h8q2a/aeyakovenko-percolator-5059332/src/ (for the engine state struct)
...
ID:           W1-public-api-reaches-absorb-protocol-loss
Claim:        The helper absorb_protocol_loss at percolator.rs:4845 debits insurance without correspondingly debiting vault (V1 confirm test fired today at this SHA with delta=+10000). This is the F7 helper-level conservation violation. Verify whether any public-instruction call path (KeeperCrank, Trade*, Deposit/Withdraw, ResolveMarket reconciliation) can reach absorb_protocol_loss with a non-zero loss argument WITHOUT a corresponding legitimate protocol bankruptcy event. Specifically, check whether the bankruptcy_hmax_lock_active gate or similar precondition prevents the public path from triggering insurance absorption when no real position loss has occurred. If any path exists where (a) insurance.balance decreases, (b) vault is unchanged, (c) no equivalent decrease in c_tot or position basis was applied, that is a win condition.
