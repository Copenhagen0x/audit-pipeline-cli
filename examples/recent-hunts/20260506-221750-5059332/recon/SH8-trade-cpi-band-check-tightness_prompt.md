...
- /tmp/jelleo-snap-aeyakovenko-percolator-k1w8zquv/aeyakovenko-percolator-5059332/src/ (all .rs files, focus on the main module)
- /tmp/jelleo-snap-aeyakovenko-percolator-k1w8zquv/aeyakovenko-percolator-5059332/spec.md (if a spec doc exists)
...
ID:           SH8-trade-cpi-band-check-tightness
Claim:        `TradeCpi`'s band check at `src/percolator.rs:6633-6655` enforces that `exec_price` is within ±100 bps of the Pyth oracle observation passed in the same instruction, and the band cannot be widened by attacker-controlled CPI matcher state writes between configuring and executing the trade.
