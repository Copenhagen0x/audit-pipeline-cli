...
- /root/audit_runs/percolator-live/target/engine/src/ (all .rs files)
...
Claim:        The lazy mark-to-market computation pnl_delta = abs_basis * (K_now - K_snap) / (a_basis * POS_SCALE) cannot overflow i128 under MAX_POSITION_ABS_Q + MAX_VAULT_TVL bounds across any K-walk reachable through cap-respecting accrue_market_to.
