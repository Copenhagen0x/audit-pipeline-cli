...
- /root/audit_runs/percolator-live/target/engine/src/ (all .rs files, focus on the main module)
- /root/audit_runs/percolator-live/target/engine/spec.md (if a spec doc exists)
