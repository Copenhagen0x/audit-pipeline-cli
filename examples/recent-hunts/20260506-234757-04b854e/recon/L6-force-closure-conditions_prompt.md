...
Claim:        Force closure of a position can only occur under exactly the conditions enumerated in spec.md (MM breach, market-pause, settlement). No undocumented force-close path exists.
