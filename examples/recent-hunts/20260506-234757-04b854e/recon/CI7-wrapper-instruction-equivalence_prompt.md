...
Claim:        Calling an engine function via the BPF wrapper produces equivalent state changes to calling the engine function directly (modulo Solana account context).
