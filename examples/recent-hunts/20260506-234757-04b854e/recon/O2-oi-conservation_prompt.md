...
Claim:        Open interest (sum of |position_q| across all longs == sum across shorts) is conserved by every fill. Long OI == Short OI at all times.
