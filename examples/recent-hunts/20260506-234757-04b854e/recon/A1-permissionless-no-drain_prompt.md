...
Claim:        Every public/permissionless instruction either requires a privileged signer OR provably cannot reduce vault below cash_locked + claimable_pnl + insurance.balance.
