...
Claim:        The funding rate captured by every instruction is computed BEFORE any mark_ewma_e6 / last_effective_price_e6 mutation in the same instruction, preventing same-tx self-bias.
