...
Claim:        The keeper crank's price-move consumption budget is not reset until every account in the swept window has actually been touched, so a reset implies real volatility was absorbed.
