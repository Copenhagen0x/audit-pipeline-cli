...
Claim:        Deposit X immediately followed by withdraw X (with no intervening activity) leaves vault + account-state byte-identical to the pre-deposit state.
