...
Claim:        Partial liquidation correctly reduces position_q + claims proportional to seized collateral. Resulting account state still satisfies all asserted post-conditions.
