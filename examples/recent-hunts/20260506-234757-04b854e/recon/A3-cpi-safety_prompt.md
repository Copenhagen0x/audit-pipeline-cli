...
ID:           A3-cpi-safety
Claim:        Any cross-program invocation invoked from within an instruction either (a) targets a fixed pubkey hardcoded in the program, or (b) verifies the target program's owner matches an explicit allowlist.
