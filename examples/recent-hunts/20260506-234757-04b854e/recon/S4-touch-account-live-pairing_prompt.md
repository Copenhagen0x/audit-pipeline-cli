...
- /tmp/jelleo-snap-aeyakovenko-percolator-prog-83wqo5nd/aeyakovenko-percolator-prog-04b854e/src/ (focus on functions that mutate multiple fields)
...
Claim:        Every public instruction that advances the engine's market clock (accrue_market_to / accrue_market_to_chunked) is paired with a touch_account_live_local on every materialized account before the next risk-gate is evaluated.
