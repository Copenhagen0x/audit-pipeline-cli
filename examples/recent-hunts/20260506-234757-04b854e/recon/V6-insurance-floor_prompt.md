...
Claim:        Insurance fund balance is monotonically non-decreasing across user-only activity (deposits, withdraws, fills) and only decreases when an insurance-draw helper is invoked under explicit conditions.
