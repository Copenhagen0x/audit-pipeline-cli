...
Claim:        touch_account_live_local is idempotent within a single instruction — calling it twice in sequence produces the same final state as calling it once.
