...
Claim:        Every PDA used as a vault or authority is derived with canonical seeds and the result is checked against the passed-in account pubkey before any state mutation.
