...
Claim:        When an account flips side (long → short or vice versa), the realized PnL on the closing portion is correctly debited/credited, and the remaining new-side basis is set to the executed fill price.
