...
ID:           SMOKE2-pre-fire-chain-test-trivial
Claim:        Smoke probe (must be false): the file src/percolator.rs contains the literal byte sequence "NEVER_MATCH_THIS_TOKEN_qwerty12345". Should verdict FALSE quickly.
