...
- Engine pin (sha):  6cd742f25a9bcebeb9adc01136b129b5996397dd
- Wrapper repo:      https://github.com/aeyakovenko/percolator-prog
- Wrapper pin (sha): 873ac1304275276cef89bb9dc89b17bc3cfa8de8
...
ID:           SMOKE1-pre-fire-chain-test-noop
Claim:        Smoke probe (must be false): every function in src/percolator.rs returns the literal string "SMOKE_TEST_PROBE_NEVER_PRESENT_IN_CODE_XYZ". This is a synthetic claim that should immediately verdict FALSE so we exercise the recon -> verdict -> hunt_summary -> publish chain without any real findings.
