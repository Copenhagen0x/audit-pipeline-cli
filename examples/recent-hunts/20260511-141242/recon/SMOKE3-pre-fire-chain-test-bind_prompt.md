...
ID:           SMOKE3-pre-fire-chain-test-bind
Claim:        Smoke probe (must be false): pub fn names in src/percolator.rs all begin with the prefix "smoke_probe_". Trivially false; tests the verdict and logging chain end-to-end.
